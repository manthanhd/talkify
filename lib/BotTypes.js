...
function StaticResponseSkill(topic, staticResponse) {
    this.topic = topic;
    ...
    return new Skill(topic+'_static_response_skill', topic, this.apply);
}

function StaticRandomResponseSkill(topic, staticResponses) {
    this.topic = topic;
    ...
    return new Skill(topic+'_static_random_response_skill', topic, this.apply);
}
